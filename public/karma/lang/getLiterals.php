...
$aTodo = array(
    array(
        'command'=>'grep -iR "l->l(" ../* | grep -v \.svn | grep -v modules',
        'regExp'=>'/l->l\(([^\)]+)\)/'
    )
    ,
    array(
        'command'=>'grep -iR "Exception" ../* | grep "throw" | grep -v \.svn | grep -v modules',
        'regExp'=>'/\(([^\)]+)\)/'
    )
    ,
    array(
        'command'=>'grep -iR \$message\ \= ../* |  grep -v \.svn | grep -v modules',
        'regExp'=>'/\=\s([^\;]+)\;/'
    )
