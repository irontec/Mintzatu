var mailconf ={
		...
		// Theme options
		theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,fullscreen", 
		
		//,styleselect,formatselect,fontselect,fontsizeselect",
		theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,search,replace,|,undo,redo,|,link,unlink,anchor",
		...
		template_replace_values : {
		 ...
		 setup : function(ed) {
        	   ...
        	   ed.onChange.add(function(ed, e) {
        	   	...
        	   	//		$('textarea.tiny').css('display',"block");
        	   	idte = $(this).attr('id');
        	   	//alert(idte);
