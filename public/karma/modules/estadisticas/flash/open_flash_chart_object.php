...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    $out[] = '<embed src="'. $base .'open-flash-chart.swf?variables=true&title=Estadisticas+Totales,{font-size:18px; color: #d01f3c}&x_axis_steps=1&y_ticks=5,10,5&line=3,#87421F&y_min=0&y_max=20&pie=60,#505050,{font-size: 12px; color: #404040;&values=5,0,5,0&pie_labels=Perdidas,Rechazadas Cola,Atendidas,Rechazadas Horario&&colours=#d01f3c,#356aa0,#C79810,#E496AB&&links=&" quality="high" bgcolor="#FFFFFF" width="'. $width .'" height="'. $height .'" name="'. $obj_id .'" align="middle" allowScriptAccess="sameDomain" ';
