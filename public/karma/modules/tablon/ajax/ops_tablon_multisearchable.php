<?php
	...
	switch($_GET['acc']) {
		case "rel":
			...
			if (isset($_GET['extrafield'])) {
			    $fields[$_GET['extrafield']] = "'".$_GET['extravalue']."'";
			}

			$ret = $pl->newRow($fields,array());
			$result = array();
			/*
			* Al loro con la vida... si algún día se pone una target_plt con borrado lógico, quizás al añadir aqui y obtener un 1062 -duplicado- quizás lo suyo sería intentar un undelete en la plantilla no?
