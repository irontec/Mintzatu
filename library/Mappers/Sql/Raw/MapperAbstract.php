...
{
    /**
     * $_dbTable - instance of Mintzatu_Model_DbTable_TableAbstract
     *
     * @var Mintzatu_Model_DbTable_TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Mintzatu_Model_DbTable_TableAbstract $dbTable
     ...
     * @param Mintzatu_Model_ModelAbstract $model
    ...
    public function loadRelated($name, $model)
    {
        ...
        if (array_key_exists($name, $parents)) {
            ...
            $table_class = 'Mappers\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            $type = 'parent';
            ...
            $ref_table_name = 'Mappers\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
    	...
    	if ($this->_cache and
	        ...
	        $relMapperClassName = "\\Mappers\\Sql\\" . $object_table_name;
        ...
        if (! empty($obj)) {
            ...
            $model_class = 'Mintzatu_Model_' . $object_table_name;
     ...
     *
     * @see Mintzatu_Model_DbTable_TableAbstract::countAllRows()
     ...
     *
     * @see Mintzatu_Model_DbTable_TableAbstract::countByQuery()
     ...
     *
     * @param Mintzatu_Model_ModelAbstract $model The model to delete
     * @return int
     */
    ...
    {
        $adapter = new Mintzatu_Model_Paginator($select, $this);
     ...
     * @return array All Mintzatu_Model_ModelAbstract meeting the criteria
     */
     ...
     * @param Mintzatu_Model_ModelAbstract|null $model
     * @return Mintzatu_Model_ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Mintzatu_Model_DbTable_TableAbstract
     */
     ...
     *
     * @param new Mintzatu_Model_ModelAbstract $model
     * @return array
     */
     ...
     * @param Mintzatu_Model_ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
